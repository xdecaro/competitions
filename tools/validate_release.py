...
def validate_source()->None:
    ...
    for token in ["searchClubs('', 200)",'getActiveSportsFederations','#__xdecarocompetitions_teams','#__xdecarocompetitions_federations']:
