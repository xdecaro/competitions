...
final class Dispatcher extends AbstractModuleDispatcher
{
    protected function getLayoutData(): array
    {
        ...
        $query = $db->getQuery(true)
            ...
            ->from($db->quoteName('#__xdecarocompetitions_countries', 'c'))
            ->leftJoin(
        ...
        $wa->registerAndUseStyle(
            'mod_xdecarocompetitions_countriesfederations.site',
            'media/mod_xdecarocompetitions_countriesfederations/css/site.css',
            [],
            ['version' => '0.3.3']
        );
        $wa->registerAndUseScript(
            'mod_xdecarocompetitions_countriesfederations.site',
            'media/mod_xdecarocompetitions_countriesfederations/js/site.js',
            [],
            ['version' => '0.3.3'],
            ['defer' => true]
        );
