<?php
namespace Xdecaro\Component\Decarodcl\Administrator\View\Organization;
...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        ToolbarHelper::title($isNew ? Text::_('COM_DECARODCL_ORGANIZATION_NEW') : Text::_('COM_DECARODCL_ORGANIZATION_EDIT'), 'building');
