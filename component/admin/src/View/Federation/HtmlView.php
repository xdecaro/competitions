<?php
namespace xdecaro\Component\Competitions\Administrator\View\Federation;
...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        ToolbarHelper::title(
            $isNew ? Text::_('COM_XDECAROCOMPETITIONS_FEDERATION_NEW') : Text::_('COM_XDECAROCOMPETITIONS_FEDERATION_EDIT'),
            'users'
        );
