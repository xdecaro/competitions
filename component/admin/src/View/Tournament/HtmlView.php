<?php
namespace xdecaro\Component\Competitions\Administrator\View\Tournament;
...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        ToolbarHelper::title(
            $isNew ? Text::_('COM_XDECAROCOMPETITIONS_TOURNAMENT_NEW') : Text::_('COM_XDECAROCOMPETITIONS_TOURNAMENT_EDIT'),
            'trophy'
        );
