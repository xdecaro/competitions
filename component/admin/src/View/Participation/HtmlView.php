<?php
namespace Xdecaro\Component\Decarodcl\Administrator\View\Participation;
...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        ToolbarHelper::title(
            $isNew ? Text::_('COM_DECARODCL_PARTICIPATION_NEW') : Text::_('COM_DECARODCL_PARTICIPATION_EDIT'),
            'list'
        );
