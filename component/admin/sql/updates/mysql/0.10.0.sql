ALTER TABLE `#__decarocompetitions_tournaments`
  ...
  ADD KEY `idx_competitions_tournaments_scope` (`scope_type`, `participant_type`);

ALTER TABLE `#__decarocompetitions_teams`
  ADD COLUMN `team_type` VARCHAR(20) NOT NULL DEFAULT 'club' AFTER `federation_id`,
  ADD KEY `idx_competitions_teams_type` (`team_type`, `approval_status`, `state`);

CREATE TABLE IF NOT EXISTS `#__decarocompetitions_tournament_countries` (
...
CREATE TABLE IF NOT EXISTS `#__decarocompetitions_tournament_zones` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `tournament_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__decarocompetitions_changes` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__decarocompetitions_edit_sessions` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `entity_type` VARCHAR(32) NOT NULL,
  `entity_id` BIGINT UNSIGNED NOT NULL,
