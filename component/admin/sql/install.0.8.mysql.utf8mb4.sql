CREATE TABLE IF NOT EXISTS `#__dcl_zones` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_dcl_zones_scope_code` (`organization_id`, `code`),
  KEY `idx_dcl_zones_organization` (`organization_id`),
  KEY `idx_dcl_zones_state` (`state`, `ordering`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `#__dcl_zone_countries` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `zone_id` INT UNSIGNED NOT NULL,
  `country_id` INT UNSIGNED NOT NULL,
  `ordering` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_dcl_zone_country_unique` (`zone_id`, `country_id`),
  KEY `idx_dcl_zone_country_zone` (`zone_id`, `ordering`),
  KEY `idx_dcl_zone_country_country` (`country_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT IGNORE INTO `#__dcl_zones` (`organization_id`, `name`, `code`, `state`, `ordering`) VALUES
