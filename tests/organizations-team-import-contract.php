...
$checks = [
    ...
    [str_contains($uiHelper, '$wa->useScript($teamImportScriptName);'), 'UiHelper must always attach the guarded Team Import script'],
    [!str_contains($uiHelper, "getCmd('view') === 'teamimport'"), 'Team Import asset loading must not depend on mutable Joomla view input'],
