...
Version 1.5.15 removes the fragile request-view condition from Team Import asset activation. The guarded Team Import JavaScript is attached through the same shared administrator Web Asset path as the already-working filterbar, live-sync, scope and People picker scripts; on unrelated pages it exits immediately because the Team Import root element is absent.
