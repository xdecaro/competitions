...
Version 1.5.12 fixes runtime delivery of the Organizations team-import live-search asset and aligns the Clear action directly with the search input. The live filter now loads reliably after Joomla package upgrades while preserving selections, counters, selected-only review and visible-row select-all.
